export const courses = [
  {
    ...
    importantItems: [
      ...
      "Learn core frontend and backend technologies",
      "Understand SQL & NoSQL databases",
      "Build responsive UI and scalable APIs"
    ],

    whoCanAttend: [
      "Students aspiring to become Full Stack Developers",
      "Frontend Developers looking to expand into backend",
      "Backend Developers aiming to learn frontend frameworks"
    ],

    prerequisites: "Basic knowledge of programming is recommended",
   ...
   {
    name: "Full Stack Web Development2",
