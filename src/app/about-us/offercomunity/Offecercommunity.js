    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-slate-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 py-16 lg:py-24 relative z-10">
        ...
        <div className='text-center mt-11'>
          ...
          {/* <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-medium">
            Online + Hybrid Training Sessions   <span className='text-[#004EA5] text-[20px]'> | </span>   Access via mobile app and web platform   <span className='text-[#004EA5] text-[20px]'> | </span>   Recorded sessions for revision and flexible
            learning   <span className='text-[#004EA5] text-[20px]'> | </span>   Certification on course completion
